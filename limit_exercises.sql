...
-- 2. MySQL provides a way to return only unique results from our queries with the keyword 
-- DISTINCT. For example, to find all the unique titles within the company, we could run 
-- the following query:
...
-- the first 5 employees hired in the 90's by sorting by hire date and limiting your results
...
-- your first page. The five after that would be your second page, etc. Update the query to 
