...
-- Hint It's a good practice to write out all of the small queries that you can. Add a 
-- comment above the query showing the number of rows returned. You will use this number 
